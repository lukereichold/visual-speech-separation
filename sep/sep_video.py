    ...
    if self.sess is None:
      ...
      with tf.device(self.gpu):
        ...
        signature = tf.saved_model.signature_def_utils.build_signature_def(
            inputs={
                      "samples_ph": tf.saved_model.utils.build_tensor_info(self.samples_ph),
                      "ims_ph": tf.saved_model.utils.build_tensor_info(self.ims_ph),
                      },
            outputs={
                      "spec_pred_fg": tf.saved_model.utils.build_tensor_info(self.spec_pred_fg),
                      "spec_pred_bg": tf.saved_model.utils.build_tensor_info(self.spec_pred_bg),
                      "samples_pred_fg": tf.saved_model.utils.build_tensor_info(self.samples_pred_fg),
                      "samples_pred_bg": tf.saved_model.utils.build_tensor_info(self.samples_pred_bg),
                      "specgram_op": tf.saved_model.utils.build_tensor_info(self.specgram_op)
                    },
